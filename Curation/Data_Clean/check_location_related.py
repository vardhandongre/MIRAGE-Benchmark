...
class CheckLocationRelated:
    ...
    def get_prompt(self, item):
        prompt = """I am processing an agricultural Q&A dataset and need assistance in identifying whether each Q&A pair is location related. Please classify each pair as {"location_related": True} or {"location_related": False} based on the following criteria:
...
Reason: The expert answer mentions 'Montgomery County' as a specific location reference, which introduces a location-based regulation not mentioned in the user's question.
</Example1>
...
Reason: The user's question already includes specific location details (Larkspur in Douglas County), and the expert answer does not introduce any additional location-specific advice or regulations.
</Example2>
...
Judgment: {"location_related": True}
Reason: The expert mentions a vague location by stating 'in our area' when discussing the conditions affecting the lilacs.
</Example3>
...
Judgment: {"location_related": False}
Reason: The expert answer does not include any specific location references or location-dependent advice. It offers general guidance on dealing with the mounds, without mentioning any geographical or local regulatory context.
</Example4>
...
Judgment: {"location_related": False}
Reason: The expert's answer provides a general fact about the species' geographic distribution rather than offering location-specific advice or regulations. According to the criteria, general geographic information is not classified as location-related.
</Example5>

<Example6>
User Question: When should I plant my tomato seedlings outdoors?
Expert Answer: The expert answer includes a vague location reference with 'our growing zone,' implying location-dependent advice even though the user did not mention any specific location.
...
Judgment: {"location_related": True}
Reason: The expert's answer refers to 'our region,' a vague location reference that introduces location-dependent advice not provided by the user.
</Example7>
...
Judgment: {"location_related": False}
Reason: The user's question already provides a specific location (Gran Canaria Isle). Although the expert mentions 'your area', it does not introduce additional or location-dependent advice beyond what was provided in the question. Therefore, this pair is not classified as location-related.
</Example8>
...
Judgment: {"location_related": False}
Reason: The user's question already includes a specific location ('Near Melbourne Australia'). The expert's answer does not introduce any new location-based information or advice but instead recommends contacting a local authority. Therefore, this pair is not classified as location-related.
</Example9>
